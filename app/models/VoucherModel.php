...
class VoucherModel extends BaseModel
{
    ...
    // ========================================================================
    // MÃ QUÀ TẶNG CHO KHÁCH CHUYỂN KHOẢN ĐỦ — ĐÃ BỎ HẲN 2026-09-06 (đợt 8)
    //
    // Bốn hàm từng nằm ở đây: reward() · clearRewardFlag() · grantTo() ·
    // rewardHeldBy(), cùng cột `vouchers.is_reward` mà chúng đọc.
    //
    // Cửa hàng tự phát một mã giảm giá cho khách chọn chuyển đủ 100%. SRS
    // không có một chữ nào về việc này — mục 3.2.9.5 chỉ cho phép người
    // tạo/sửa/bật-tắt mã và phát mã theo quyết định của mình. Xem migration
    // 2026-09-06-dot-8-go-ma-qua-tang.sql, phần "thu hồi mã đã phát".
    //
    // grantToAll() ở TRÊN thì GIỮ: đó là "phát mã riêng cho toàn bộ khách
    // hiện có" mà SRS 3.2.9.5 cho phép — người bấm, không phải máy tự làm.
    // ========================================================================
