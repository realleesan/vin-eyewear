...
class EventDetailController extends BaseController
{
    private function getEventsData(): array 
    {
        return [
            'uu-dai-bo-suu-tap-di-san-mua-he' => [
                ...
                'published_at' => '10/07/2026 09:30:45',
                'author' => 'VIN EYEWEAR ADMIN',
            ...
            'buoi-chia-se-bao-quan-kinh-nhua-cao-cap' => [
                ...
                'category' => 'SỰ KIỆN',
                'date' => '05/08/2026',
                'published_at' => '28/07/2026 14:30:45',
                'author' => 'VIN EYEWEAR ADMIN',
            ...
            'ra-mat-dong-kinh-titan-sieu-nhe' => [
                ...
                'date' => '20/08/2026',
                'published_at' => '15/08/2026 10:15:30',
                'author' => 'VIN EYEWEAR ADMIN',
            ...
            'trien-lam-nghe-thuat-khung-kinh-qua-cac-thap-ky' => [
                ...
                'published_at' => '20/08/2026 16:45:20',
                'author' => 'VIN EYEWEAR ADMIN',
            ...
            'chuong-trinh-kham-thi-luc-va-tu-van-dang-kinh' => [
                ...
                'published_at' => '18/08/2026 13:20:10',
                'author' => 'VIN EYEWEAR ADMIN',
            ...
            'dem-tiec-trai-nghiem-nhuom-mau-trong-kinh-thu-cong' => [
                ...
                'category' => 'SỰ KIỆN',
                'date' => '30/09/2026',
                'published_at' => '22/09/2026 11:05:55',
                'author' => 'VIN EYEWEAR ADMIN',
                'image' => 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?q=80&w=1200',
    ...
    public function detail($eventId = null): void
    {
        $eventsData = $this->getEventsData();
        
        if (!$eventId || !isset($eventsData[$eventId])) {
        ...
        $relatedEvents = array_slice(array_filter($eventsData, function($e) use ($eventId) {
            return $e['id'] !== $eventId;
        }), 0, 3);
        
        $data = [
            'title' => $event['title'] . ' - Vin Eyewear',
            'pageTitle' => 'Chi tiết sự kiện',
            'event' => $event,
