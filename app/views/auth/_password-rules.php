...
/**
 * auth/_password-rules.php — bốn dòng quy tắc dưới ô mật khẩu.
 *
 ...
 *
 * Bốn dòng này phải KHỚP với passwordProblem() trong core/helpers.php — đó mới
 * là nơi quyết định, còn đây chỉ là bản đọc được của nó.
 *
