...
/**
 * auth/_google-icon.php — logo Google bốn màu, 18×18.
 *
 * Bốn <path> này từng nằm nguyên văn ba lần trong auth/index.php (nút submit
 * ở màn đăng ký, thẻ <a> ở màn đăng nhập, nút disabled khi chưa cấu hình).
 * Khối "Tài khoản Google" ở trang Hồ sơ cần bản thứ tư, và bốn bản sao của
 * cùng một hình là bốn chỗ phải sửa khi Google đổi logo — nên tách ra đây.
 *
 * aria-hidden: hình này không mang thông tin nào mà chữ bên cạnh ("Tiếp tục
 * với Google", "Liên kết tài khoản Google") chưa nói. Trình đọc màn hình đọc
 * cả hai là đọc thừa.
 */
?>
