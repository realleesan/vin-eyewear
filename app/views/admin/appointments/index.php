...
<?php
/*
 * KHÔNG CÒN HỘP THOẠI TẠO LỊCH HẸN — SRS v2.1.0, G10.
 *
 * Trước đây trang này có nút "+ Tạo lịch hẹn" và một hộp thoại mở theo ?them=1
 * để nhân viên đặt hộ khách gọi điện. Chủ đầu tư đã bỏ đường vào này: khách gọi
 * điện thì nhân viên hướng dẫn khách tự đặt trên web, nên chỉ còn MỘT đường tạo
 * lịch và một bộ luật về ngày hợp lệ.
 */
